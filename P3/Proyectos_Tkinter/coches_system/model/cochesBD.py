...
class Camionetas:
    ...
    def actualizar(marca,color,modelo,velocidad,caballaje,plazas,traccion,cerrada,id):
        ...
        try:
            cursor.execute(
                "update autos set marca=%s,color=%s,modelo=%s,velocidad=%s,caballaje=%s,plazas=%s,traccion=%s,cerrada=%s where id=%s",
...
class Camiones:
        ...
        def actualizar(marca,color,modelo,velocidad,caballaje,plazas,eje,capacidadcarga,id):
            try:
                cursor.execute(
                "update autos set marca=%s,color=%s,modelo=%s,velocidad=%s,caballaje=%s,plazas=%s,eje=%s,capacidadcarga=%s, where id=%s",
