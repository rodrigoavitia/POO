...
#         ctk.CTkLabel(self.right_panel, text="Registro de Usuarios", font=("Arial", 24, "bold"), text_color="#101828").pack(anchor="w", pady=(10, 0))
#         ctk.CTkLabel(self.right_panel, text="Alta de alumnos, docentes y administrativos", font=("Arial", 14), text_color="#64748B").pack(anchor="w", pady=(0, 20))
...
#             button_color="#E5E7EB",
#             command=self.verificar_cambio_rol 
#         )
...
#         ctk.CTkLabel(self.frame_credenciales, text="Correo Institucional (Login) *", font=("Arial", 12, "bold"), text_color="#334155").pack(anchor="w", pady=(10, 5))
...
#         ctk.CTkLabel(self.frame_credenciales, text="Contraseña de Acceso *", font=("Arial", 12, "bold"), text_color="#334155").pack(anchor="w", pady=(10, 5))
...
#         self.lbl_fuerza = ctk.CTkLabel(self.frame_credenciales, text="Seguridad: Baja", font=("Arial", 10), text_color="gray")
...
#         ctk.CTkLabel(self.left_panel, text="Registro centralizado\nde usuarios UTD.", font=("Arial", 14), text_color="#F0FDFA", justify="left").place(x=32, y=320)
...
#         """Restaura todas las opciones de roles"""
#         self.frame_credenciales.pack_forget()
        
#         origen = self.controller.vista_retorno 
#         if origen == "SudoteView":
#             opciones = ["Estudiante", "Docente", "Administrativo", "Trabajador", "Sudito (Admin)"]
#         else:
#             opciones = ["Estudiante", "Docente", "Administrativo", "Trabajador"]
...
#         """
#         Muestra campos de contraseña SOLO si el rol es EXACTAMENTE 'Sudito (Admin)'.
#         Corregido para que 'Administrativo' NO active esto.
#         """
#         if eleccion == "Sudito (Admin)":
...
#                 # Preguntar vehículo solo si NO es Admin
#                 if rol != "Sudito (Admin)":
#                     if messagebox.askyesno("Vehículo", f"¿Desea registrar un vehículo para {nombre} ahora?"):
#                         self.controller.usuario_preseleccionado = {
#                             'id': exito,
#                             'nombre': f"{nombre} {ape_pat}",
#                             'rol': rol
#                         }
#                         self.controller.show_frame("RegistrarVehiculo")
                
#         except Exception as e:
#             messagebox.showerror("Error de BD", f"{e}")
...
"""
COMENTADO YA QUE AL FINAL REGISTRAR Y GESTIONAR USUARIOS LOS DEJAMOS JUNTOS PERO A FUTURO LO DEJAREMOS EN PAQUETES INDIVIDUALES,
SI ENCONTRAMOS LA MANERA.

ADEMAS DE QUE DEJANDOLO EN UN SOLO
"""