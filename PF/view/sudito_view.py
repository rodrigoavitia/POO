...
class SuditoView(ctk.CTkFrame):
    def __init__(self, master, controller):
        ...
        ctk.CTkLabel(self.main_area, text="Bienvenido, Operador", font=("Arial", 24, "bold"), text_color="#111827").pack(anchor="w")
        ctk.CTkLabel(self.main_area, text="Resumen de actividad diaria del estacionamiento", font=("Arial", 14), text_color="gray").pack(anchor="w", pady=(0, 20))
